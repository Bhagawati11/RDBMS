...
- resolving deletion anamoly using 3nf
CREATE TABLE Donations (
    DonationID INT PRIMARY KEY,
    DonorName VARCHAR(100),  -- Not normalized
    ContactInfo VARCHAR(50), -- Not normalized
    ProjectID INT,
    Amount DECIMAL(10,2)
);
INSERT INTO Donations (DonationID, DonorName, ContactInfo, ProjectID, Amount)
VALUES 
    (1, 'Alice Johnson', 'alice@example.com', 101, 500),
    (2, 'Bob Smith', 'bob@example.com', 102, 300),
    (3, 'Alice Johnson', 'alice@example.com', 103, 200);
select * from Donations;


DELETE FROM Donations WHERE DonationID = 1;
DELETE FROM Donations WHERE DonationID = 3;
